...
<body>
	...
	<div class="section">
		<div class="container">
			<h3>Data Kategori</h3>
			<div class="box">
				<p><a class="btn" href="tambah-kategori.php">Tambah Data</a></p>
				<br>
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a class="success" href="edit-kategori.php?id=<?php echo $row['category_id'] ?>">Edit</a> 
								<a  class="danger" href="proses-hapus.php?idk=<?php echo $row['category_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')">Hapus</a>
							</td>
						</tr>
						<?php }}else{ ?>
							<tr>
